...
public class IQ_8_12_EightQueens {
	 ...
	 * queen in the same column or diagonal, We don't need to check if for queens in
	...
	boolean checkValid(Integer[] columns, int row1, int column1) {
		for (int row2 = 0; row2 < row1; row2++) {
			...
			/* Check ig (row2, column2) invalidates (row1, column1) as a 
			 * queen spot. */
